# ‚òÅÔ∏è Azure Administrator (AZ-104) Lab Projects

Welcome to my Azure infrastructure portfolio! Ì∫Ä
...
| :--- | :--- | :--- |
| **01-Networking** | Architecting secure and scalable networks. | VNets, Subnetting, Peering, DNS, NSG/ASG. |
| **02-Identity** | Managing authentication and authorization. | Entra ID, RBAC, Policy. |
...
### Ì≥° [Lab 04] Implement Virtual Networking
...
- **Key Achievements:**
  ...
  - Automated deployment using **ARM Templates (JSON)**.
  - Implemented **Micro-segmentation** using Application Security Groups (ASGs).
  - Configured **Azure Private DNS** for secure internal name resolution.

---
*Maintained by Emad Elsayed Singab*
